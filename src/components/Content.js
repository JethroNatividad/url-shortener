        ...
        <div className="flex flex-col items-center mt-48">
            ...
            <div className="mt-10 w-1/3 h-40 rounded-2xl px-5 py-10 shadow-gray-400 shadow-lg bg-white">
                <div className="bg-gray-100 flex p-3 rounded-xl items-center">
                    ...
                    <input value={input} onChange={handleInputChange} className={`outline-none bg-transparent flex-1 text-xl ${urlError.error && "text-red-600"}`} placeholder="Paste link to shorten it" />
                    <button onClick={() => {
