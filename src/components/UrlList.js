            ...
            <table className="w-1/3">
                ...
                {urls.map((url, index) => (
                    <tr key={index} className='bg-white shadow-sm shadow-gray-400'>
                        <td className="px-3 py-1 text-blue-800 hover:underline"><a href={url.main_url} target="_blank" rel="noreferrer">{url.main_url}</a></td>
                        <td className="px-3 py-1 text-blue-800 hover:underline"><a href={url.short_url} target="_blank" rel="noreferrer">{url.short_url}</a></td>
